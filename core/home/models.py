...
class ScraperControl(models.Model):
    ...
    searching_state_name = models.CharField(max_length=100,null=True,blank=True)
    searching_key = models.CharField(max_length=100,null=True,blank=True)


class Client(models.Model):
    site_url = models.URLField(max_length=100,null=True,blank=True)
...
class TenderResults(models.Model):
    search_time=models.CharField(max_length=100,null=True,blank=True)
    tender_id=models.CharField(max_length=100,null=True,blank=True)
    state_name=models.CharField(max_length=100,null=True,blank=True)
    search_key=models.CharField(max_length=100,null=True,blank=True)
    site_link=models.CharField(max_length=100,null=True,blank=True)
    work_description=models.TextField(null=True,blank=True)
    organization_chain = models.CharField(max_length=100,null=True,blank=True)
    ...
    tender_value = models.CharField(max_length=100,null=True,blank=True)
    emd_amt = models.CharField(max_length=100,null=True,blank=True)
    tender_fee = models.CharField(max_length=100,null=True,blank=True)
    # user=models.ForeignKey(User, on_delete=models.CASCADE,null=True,blank=True)
